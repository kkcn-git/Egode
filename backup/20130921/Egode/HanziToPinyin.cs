...
{ -20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, 
 ...
 { "A", "Ai", "An", "Ang", "Ao", "Ba", "Bai", "Ban", "Bang", "Bao", "Bei", 
	...
	private static string[] _unknownHz = new string[]{
		"ÖØÇì,ChongQing",
		"ãÉÐÐ,MinHang",
		"ãÉ,Min", "çû,Kun", "çæ,Ke", "Â¦,Lou", "Ü½,Fu", "ïÉ,E", "ìõ,Zhen", "öÎ,Xin", "ìè,Hu", "Œu,Cai", 
		"Ù»,Qian", "áé,Qu", "Ý·,Xin", "Ý¼,Jing", "ê»,Hao", "çø,Ying", "äÁ,Song", "è¤,Yu", "ãþ,Jing", "äà,Li", 
		"ö©,Wen", "çù,Qi", "Ü°,Xin", "è´,Lu", "æÂ,Yuan", "êØ,Xi", "ôË,Xi", "î£,Rui", "†´,Zhe", "ÜÇ,Rui",
		"âù,Yi", "äµ,Lai", "Ýç,Jia", "ÚS,Yun", "÷È,Mei", "èª,Jin", "äº,Bang", "öÁ,Juan", "èµ,Bi", "Û´,Yin",
		"èº,Tao", "æ¯,Jiao", "èó,Fan", "ì¿,Wei", "çô,Xi", "­Z,Jing", "è¯,Xuan", "æÃ,Ting", "Û¡,Di", "Úù,Wu",
		"òÔ,Jiao", "ä°,Hu", "åû,Yan", "å¡,Sui", "•F,Min", "Ø®,Yu", "Ü¤,Dai" ,"Ø·,Yin", "ä¥,Zhen", "æ¼,Jie",
		"ãÑ,Chang", "æÄ,Wu", "çã,Fen", "îå,Shuo", "î¡,Sui", "æµ,Xian", "áÔ,Song", "êÌ,Yan", "è¡,Chen", "Þ±,Wei",
		"ÛÚ,Zhen"};
	...
	//{
	//    if (string.IsNullOrEmpty(hzString))//ÊäÈëÎª¿Õ
	//        return null;

	//    // Ô¤´¦Àí.
	//    char str = '"';//Ó¢ÎÄ×´Ì¬Ë«ÒýºÅ´¦Àí
