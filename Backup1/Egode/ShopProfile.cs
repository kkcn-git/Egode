		...
		public static List<ShopProfile> Shops
		{
			get
			{
				if (null == _shops)
				{
					...
					_shops.Add(new ShopProfile(ShopEnum.EgoGermany, "败遍欧洲", "1029290077", "buy欧洲", "bu**洲", "eur8", "顾双双", "18964913317", "https://eur8.taobao.com", "orders-eur8-c.xml", "orders-eur8-c.xml"));
