...
{  
    ...
    {  
        ...
        {  
            ...
            private float m_Magnify = 0;  
            /// <summary>  
            /// 放大倍数  
            /// </summary>  
            public float Magnify { get { return m_Magnify; } set { m_Magnify = value; } }  
            /// <summary>  
            /// 条码类别  
            /// </summary>  
            public enum Encode  
            ...
            {  
                ...
                for (int i = 0; i != _Value.Length; i++)  
                {  
                    int _ValueNumb = (int)(Int32.Parse(_Value[i].ToString()) * (m_Magnify + 1)); //获取宽和放大系数  
                    if (!((i & 1) == 0))  
                    {  
